...
void increasingKey(int index,int value)
{
...
while(1) {
    ...
    switch (ch) {
        ...
        case 1:
            ...
            break;
        case 2:
            cout<<"Extracted --->"<<getmax()<<" from the heap"<<endl;
        ...
        case 5:
            int val,index;
            cout<<"Enter inde and num"<<endl;
            cin>>index>>val;
            increasingKey(index,val);
            break;
        case 6:
            int al,ndex;
            cout<<"Enter inde and num"<<endl;
